...
WebUI.setText(findTestObject('Page_Fit by Beat/input_age'), '22,5')
...
WebUI.verifyElementText(findTestObject('Page_Fit by Beat/warning-invalid-age'), 'Please provide a valid age')
