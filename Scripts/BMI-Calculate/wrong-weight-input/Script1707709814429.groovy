...
WebUI.setText(findTestObject('Page_Fit by Beat/input_weight'), '48,3')
...
WebUI.verifyElementText(findTestObject('Page_Fit by Beat/warning-invalid-weight'), 'Please provide a valid weight')
