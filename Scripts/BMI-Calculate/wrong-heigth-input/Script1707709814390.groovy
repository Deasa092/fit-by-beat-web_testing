...
WebUI.setText(findTestObject('Page_Fit by Beat/input_height'), '155,6')

WebUI.setText(findTestObject('Page_Fit by Beat/input_weight'), '48')
...
WebUI.verifyElementText(findTestObject('Page_Fit by Beat/warning-invalid-height'), 'Please provide a valid height')
